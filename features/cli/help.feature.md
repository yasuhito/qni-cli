...
## Scenario: qni --help は成功する

- When "qni --help" を実行
- Then コマンドは成功

## Scenario: qni --help はコマンド一覧を表示
...
## Scenario: qni -h は成功する

- When "qni -h" を実行
- Then コマンドは成功

## Scenario: qni -h はコマンド一覧を表示
...
## Scenario: qni help add は失敗する

- When "qni help add" を実行
- Then コマンドは失敗

## Scenario: qni help add はエラーを表示
