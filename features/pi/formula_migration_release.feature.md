...
- Then リポジトリファイル "docs/releases/pi-formula-0.1.1-update.md" は "pi install npm:qni-cli" を含む

## Scenario: pi-formula の版範囲を使わない

- Then リポジトリファイル "package.json" は "\"pi-formula\": \"0.1.1\"" を含む

## Scenario: pi-formula 0.1.1 はロックファイルにも固定する

- Then リポジトリファイル "package-lock.json" は "\"resolved\": \"https://registry.npmjs.org/pi-formula/-/pi-formula-0.1.1.tgz\"" を含む

## Scenario: pi-formula 0.1.1 の実端末確認結果を記録する

- Then リポジトリファイル "docs/releases/pi-formula-0.1.1-update.md" は "Ghostty 1.3.1 と Kitty 0.48.2 の両方" を含む

## Scenario: pi-formula 0.1.1 の画面を記録する

- Then リポジトリファイル "docs/releases/pi-formula-0.1.1-update.md" は "pi-formula-0.1.1-ghostty.png" を含む
