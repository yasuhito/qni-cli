...
- Optionally modify: `features/add_phase_gate.feature`
...
- `features/add_phase_gate.feature`
...
```bash
git add features/katas/basic_gates/phase_change.feature features/add_phase_gate.feature features/qni_run.feature features/qni_expect.feature lib/qni
...
**Files:**
- Test: `features/add_phase_gate.feature`
